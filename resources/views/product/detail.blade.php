                        ...
                        <div class="component_rating" style="margin: 20px 0;">
                            ...
                            <div class="component_rating_content" style="display: flex; align-items: center; border-radius: 5px; border: 1px solid #dedede;">
                                <div class="rating_item" style="width: 20%; position: relative;">
                                    <span class="fa fa-star" style="font-size: 100px; display: block; color: #ff9705; margin: 0 auto; text-align: center;"></span><strong style="position: absolute; top: 50%; left: 50%; transform: translate(-50%,-50%);font-size: 20px; color: white;"> 2.5</strong>
                                </div>
                                ...
                                <div class="item_rating" style="display: flex; align-items: center;">
                                    ...
                                    <div style="width: 75%; margin: 0 20px;">
                                        <span style="width: 100%; height: 8px; display: block; border: 1px solid #dedede; background-color: #dedede; border-radius: 5px;"><strong style="width: 30%; background-color: #f25800; display: block; border-radius: 5px; height: 100%;"></strong></span>
                                    </div>
                                    <div style="width: 20%">
